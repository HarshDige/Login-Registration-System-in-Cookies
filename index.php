...
<body>
    <div class="container">
            ...
            <h1 class="h1"> Login Form</h1>  
                    ...
                    <form action="login-code.php" method="POST">
                            ...
                            <div  class="input-group  login-input ">
                                    ...
                                    <input onkeyup="passvali()" type="password" id="pass" name="password" placeholder="Password" value="" class="form-control back berror" aria-describedby="icone">  
         ...
         <img src="photo-1566888596782-c7f41cc184c5.avif" id="image" width="399px" height="595px">           
